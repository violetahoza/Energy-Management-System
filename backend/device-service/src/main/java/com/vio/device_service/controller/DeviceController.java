...
public class DeviceController {
    ...
    @PostMapping("/sync/unassign-user/{userId}")
    @Operation(summary = "Unassign all devices from a deleted user", description = "Internal endpoint that removes user assignments from all devices when a user is deleted from the system. The devices remain in the database but their userId is set to null, making them available for reassignment. This endpoint is called by the User Service after a user deletion.")
    @ApiResponses(value = {
    ...
    public ResponseEntity<Void> unassignUserDevices(@PathVariable Long userId) {
        ...
        service.unassignDevicesForDeletedUser(userId);
